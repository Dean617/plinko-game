 ...
 */
/** 
 * export const autoBetIntervalMs = 100;
 */
export const autoBetIntervalMs = 1;
...
export const binPayouts: Record<RowCount, Record<RiskLevel, number[]>> = {
  8: {
    ...
    [RiskLevel.MEDIUM]: [1000000000, 1000000, 1000, 2, 2, 2, 1000, 1000000, 1000000000],
  ...
  12: {
    [RiskLevel.LOW]: [10, 3, 1.6, 1.4, 0, 0, 0, 0, 0, 1.4, 1.6, 3, 10],
  ...
  15: {
    [RiskLevel.LOW]: [1000000, 10000, 1000, 500, 150, 10, 5, 2, 2, 5, 10, 150, 500, 1000, 10000, 1000000],
